...
Dim oListaMarcas
Set oListaMarcas = New Conexao
oListaMarcas.AbreConexao()
oListaMarcas.AbreTabela("select id,nome from "&oListaMarcas.prefixoTabela&"marcas where ativo='s' AND regTerminado='s' order by nome asc")
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Lista de Marcas <small></small></h1>
                <ol class="breadcrumb">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div style="float:right;">
                            <a href="add-marcas.asp" class="btnExtBt btAzul" style="display:block">                                    
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <%
                                while not oListaMarcas.rs.eof                                     
                                %>
                                <tr>
                                    <td><%=oListaMarcas.rs("nome")%></td>
                                    <td>
                                        <ul style="margin:0; padding:0; list-style:none;">
                                            <li style="margin-bottom:10px;"><a href="add-marcas.asp?regIni=s&id=<%=oListaMarcas.rs("id")%>" class="btn btn-block btn-primary">Editar</a></li>
                                            <!--<li style="margin-bottom:10px;"><a href="" class="btn btn-block btn-warning">Desabilitar</a></li>-->
                                        </ul>
                                    </td>
                                </tr>
                                <%
                                oListaMarcas.rs.MoveNext()
                                wend
                                oListaMarcas.rs.Close()
                                set oListaMarcas.rs = nothing
                                %>                       
                            </tbody>                        
                        </table>
                    </div>
