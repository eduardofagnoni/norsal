...
oPersists.UploadDeArquivo(oConexaoEdit.upNovidades)

oConexaoEdit.UpdateItem("UPDATE "&oConexaoEdit.prefixoTabela&"novidades SET fotoTopoPagina='"&oPersists.txtArquivo&"' WHERE id="&id)
