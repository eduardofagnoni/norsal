...
oPersists.UploadDeArquivo(oConexaoEdit.upProdutos)

oConexaoEdit.UpdateItem("UPDATE "&oConexaoEdit.prefixoTabela&"produtos SET foto='"&oPersists.txtArquivo&"' WHERE id="&id)
