...
oListaProjeto.AbreTabela("select id,nome,data from "&oListaProjeto.prefixoTabela&"projetos where ativo='s' AND regTerminado='s' order by nome asc")
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Lista de Projetos <small></small></h1>
                <ol class="breadcrumb">
