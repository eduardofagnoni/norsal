...
oPersists.UploadDeArquivo(oConexaoEdit.upGalerias)
oConexaoAdd.AddItem("INSERT INTO "&oConexaoAdd.prefixoTabela&"galeriadeimagensarquivo (idGaleria, arquivo, dadosIniciais, ultimaAlteracao) values ('"&id&"','"&oPersists.txtArquivo&"','"&cadastro_dados_iniciais&"','"&ultima_alteracao&"')")
