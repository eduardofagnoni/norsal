    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>Adicionando um Projeto <small></small></h1>
                <ol class="breadcrumb">
                    ...
                    <li class="active">Adicionando um Projeto</li>
                </ol>
            </section>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <figure style="margin-bottom:20px;text-align:center">
                                ...
                                %>
                                    <img src="<%=oEditRegistro.enderecoProjetos%><%=oEditRegistro.rs("fotoCapa")%>" alt="" style="max-width:100%;" >
                                <%
                                else
                                %>
                            ...
                            <figure style="margin-bottom:20px;text-align:center">
                                ...
                                %>
                                    <img src="<%=oEditRegistro.enderecoProjetos%><%=oEditRegistro.rs("fotoTopoPagina")%>" alt="" style="max-width:100%;" >
                                <%
                                else
                                %>
                                    <img src="images/avtr.gif" alt="" style="max-width:100%;" >
